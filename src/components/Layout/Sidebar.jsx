...
import { User, Briefcase, GraduationCap, Code2, FolderOpen, Award, Globe, ChevronRight, RotateCcw, FlaskConical, Upload, Plus, LayoutTemplate } from 'lucide-react';
...
export const SECTIONS = [
  ...
  { id: 'languages',      label: 'Languages',        icon: Globe,         dataKey: 'languages' },
];
