...
export default function PersonalInfoForm() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-slate-500 mb-6">Your basic contact details shown at the top of the resume.</p>
      ...
      <div className="mt-4">
        ...
        <textarea
          ...
          className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none"
        />
